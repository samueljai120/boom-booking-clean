...
export function withTenantContext(handler) {
  return async (req, res) => {
    try {
      ...
      // If tenant is required but not found, return error (unless this is the main domain or localhost)
      if (!tenant && req.method !== 'OPTIONS' && !isMainDomain && !isLocalhost) {
